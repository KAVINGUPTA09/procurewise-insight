...
export const Route = createFileRoute("/analysis/$analysisId")({
  head: () => ({
    meta: [
      { title: "Procurement Analysis Result — ProcureMind AI" },
      {
        name: "description",
        content:
          "Vendor ranking, compliance breakdown and the AI procurement recommendation for this analysis.",
      },
      { property: "og:title", content: "Procurement Analysis Result — ProcureMind AI" },
      {
        property: "og:description",
        content: "Review vendor scores, compliance checks and the recommended award decision.",
      },
    ],
  }),
